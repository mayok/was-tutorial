...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'tmp.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'tmp.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'tmp.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "tmp.js.mem" : null;




var STATIC_BUMP = 6800;
...
Module["asm"] = asm;
var _preEmphasis = Module["_preEmphasis"] = function() { return Module["asm"]["_preEmphasis"].apply(null, arguments) };
